...
interface StudentLoginNewProps {
  onBack: () => void;
  onLoginSuccess: () => void;
  onSignupClick: () => void;
}

export const StudentLoginNew: React.FC<StudentLoginNewProps> = ({
  onBack,
  onLoginSuccess,
  onSignupClick,
}) => {
      ...
      >
        <div className="glass-medium border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl text-white mb-2">Student Login</h2>
            <p className="text-white/60">Enter your college credentials</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl text-white relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <button
            ...
            className="w-full text-center text-white/60 hover:text-white smooth-transition"
          >
